...
const SellListings = () => {
  ...
  return (
    <div className="px-4 py-6">
      ...
      >
        <h1 className="text-2xl font-bold text-gray-900">Sell Listings</h1>
        <div className="flex items-center space-x-4">
          <p className="text-gray-600">Total: {listings.length} properties</p>
          <Button variant="primary" onClick={handleAddPropertyClick} className="flex items-center">
